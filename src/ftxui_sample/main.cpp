...
// configuration step. It creates a namespace called `karya`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", karya::cmake::project_name, karya::cmake::project_version) };
